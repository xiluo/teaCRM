...
namespace  teaCRM.Dao.Impl
{
    ...
    /// <summary>
    /// 自动生成的实现ITFunAppCompanyDao接口的Dao类。 2014-09-19 04:25:19 By 唐有炜
    /// </summary>
 public class TFunAppCompanyDaoImpl:ITFunAppCompanyDao
    {
	  ...
	  //===========================================================================
	   /// <summary>
        ...
        /// <returns>集合</returns>
        public IEnumerable<TFunAppCompany> GetListBySql(string sql, dynamic namedParameters)
        {
          using (teaCRMDBContext db=new teaCRMDBContext())
            {
   ...
   #region 写操作
       ...
       /// <summary>
        ...
        public bool DeletesEntity(List<TFunAppCompany> list) 
        {
            using (teaCRMDBContext db=new teaCRMDBContext())
            {
