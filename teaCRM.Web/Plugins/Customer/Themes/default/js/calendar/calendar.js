...
Calendar.dayMouseOver = function(ev) {
	...
	if (el.ttip) {
		if (el.ttip.substr(0, 1) == "_") {
			...
			el.ttip = "";
			var xx = date.print("y")+date.print("M")+date.print("d");//alert(xx)
...
Calendar.cellClick = function(el) {
	...
	if (typeof el.navtype == "undefined") {
		...
		//cal.callCloseHandler();//单击也引用关闭;added by jarry //点击日期的时候界面不能关闭
	} else {
		if (el.navtype == 200) {
			Calendar.removeClass(el, "hilite");
...
Calendar.prototype.create = function (_par) {
	...
	/*var form =document.getElementById("tb-click");
...
//	(this.weekNumbers) && ++title_length;
	...
	this._nav_py = hh("<img id=objyprev src=\"js/calendar/img/yprev.gif\">", 1, -2);
...
//	this._nav_py = hh("&#x00ab;", 1, -2);
	...
	//	this._nav_ny = hh("&#x00bb;", 1, 2);
	this._nav_ny = hh("<img id=objynext src=\"js/calendar/img/ynext.gif\">", 1, 2);
	this._nav_ny.width = 25;
	//this._nav_ny.ttip = Calendar._TT["NEXT_YEAR"];

//	this._nav_pm = hh("&#x2039;", 1, -1);
	this._nav_pm = hh("<img id=objmprev src=\"js/calendar/img/mprev.gif\">", 1, -1);
...
//	this._nav_nm = hh("&#x203a;", 1, 1);
	this._nav_nm = hh("<img id=objmnext src=\"js/calendar/img/mnext.gif\">", 1, 1);
...
//	this.title.firstChild.data = year + "年" + Calendar._MN[month];
	...
	this.title2.firstChild.data = Calendar._MN[month]+"月"; 
	// PROFILE
