...
(function ($)
{
    ...
    $.ligerDefaults.Grid = {
        ...
        pageSizeOptions: [10, 30, 50],  //可选择设定的每页结果数
        parms: [],                         //提交到服务器的参数
        columns: [],                          //数据源
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            gridhtmlarr.push("            <div class='l-panel-pager'><div class='l-bar-group l-bar-selectpagesize'></div>");
            ...
            gridhtmlarr.push("                </div>");
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            gridhtmlarr.push("                <div class='l-clear'></div></div>");
            gridhtmlarr.push("            </div>");
            gridhtmlarr.push("         </div>");
        ...
        */
        ...
        _initFootbar: function ()
        {
            ...
            if (p.usePager)
            {
                ...
                var optStr = "";
                var selectedIndex = -1;
                var ligerPageSize = $.cookie('ligerPageSize') || p.pageSize;
                $(p.pageSizeOptions).each(function (i, item)
                {

                    var selectedStr = "";
                    if (ligerPageSize == item) selectedIndex = i;
        ...
        _setEvent: function ()
        {
            ...
            $('select', g.toolbar).change(function ()
            {
                ...
                $.cookie('ligerPageSize', p.pageSize, {expires: 99});
            });
            //工具条 - 切换当前页事件
