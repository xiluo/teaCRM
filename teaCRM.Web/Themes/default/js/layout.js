...
function showMore() {
    ...
    $("#nav-more").click(function() {
            d_more = dialog({
                content: ' <ul class="nav" style="background:#1173ee;"><li id="nav-sale"><a href="/Apps/Sale/">销售</a></li><li id="nav-product"><a href="/Apps/Product/">产品</a></li><li id="nav-service"><a href="/Apps/Service/">服务</a></li></ul>',
                quickClose: true // 点击空白处快速关闭
            });
            d_more.show(this);
        })
